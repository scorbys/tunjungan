                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="form-group">
                                ...
                                <select name="level" class="form-control" required>
                                    <option value="1" <?php if($a->level == 1){ echo 'selected'; }else{ echo 'hidden'; } ?>>Admin KUD Tunjungan</option>
                                    <option value="2" <?php if($a->level == 2){ echo 'selected'; }elseif($a->level == 1){ echo 'hidden'; } ?>>Kasir KUD Tunjungan</option>
