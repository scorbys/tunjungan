                                    ...
                                    <table class="table table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td colspan="7"></td>
                                                <td>
                                                    <a href="<?= base_url() ?>kasir/ppob/pln/pasca/<?= $id_pel.'/'.$denom.'/'.$id_agen ?>" class="btn btn-warning btn-block pull-right"><i class="fa fa-arrow-circle-right"></i> Lanjutkan Transaki</a>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
