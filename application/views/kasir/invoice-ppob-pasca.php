            ...
            <div class="col-lg-10">
                <div class="box box-success">
                    <div class="box-header with-border">
                        ...
                        <h2 class="box-title"><b><i class="fa fa-mobile-phone"></i> Invoice Pembelian PLN -  Listrik Pascabayar</b></h2>
                    </div>
                    <div class="box-body">
                        <div class="row">
                                    ...
                                    <table class="table table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?= $c->id_pel; ?></td>
                                                <td>Pembayaran listrik <?= $this->db->query("SELECT * FROM tbl_produk_agratek WHERE code_produk = '$c->denom' LIMIT 1")->row()->penyedia.' - '.$c->denom; ?> </td>
                                                ...
                                                <td>
                                                    <?php if($c->status != 'SUCCESS'){
                                                        echo '<a href="kasir/ppob/cek/pasca/'.$c->invoice_no.'" class="btn btn-danger btn-block"><i class="fa fa-refresh"></i> Update Status</a>';
                                                    } ?>
                                                </td>
                                            </tr>
                                            <?php endforeach ?>
                                            <tr>
                                                <td colspan="7"></td>
                                                <td>
                                                    <a href="kasir/ppob/cetak/pasca/<?= $id ?>" class="btn btn-success btn-block pull-right" target="_blank"><i class="fa fa-print"></i> Cetak Transaki</a>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
